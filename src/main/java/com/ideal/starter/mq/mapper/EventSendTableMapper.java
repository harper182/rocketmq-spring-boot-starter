...
public interface EventSendTableMapper {
    ...
    List<EventSendTable> getEventTablesBeforeDate(@Param("createTime") Date createTime, @Param("eventStatus") EventSendStatus eventStatus,@Param("retryTime") int retryTime);
