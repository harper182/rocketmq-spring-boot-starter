...
public class SimpleConsumer {
    ...
    public SimpleConsumer(String messageMode, String consumerGroup,List<MethodInfo> subscribers,MQProperties mqProperties) {
    ...
    protected void handleMessage(MessageExt messageExt) {
        for (MethodInfo methodInfo : subscribers) {
            ...
            if (isMatch(subscriber, messageExt)) {
                ...
                try {
                    methodInfo.invoke(object,messageExt);
